...
<td width="55%" valign="top" style="padding:15px;">
  ...
  <p align="center">
    <strong>GAS를 활용하여 주요 시스템을 구현한 멀티플레이 하이퍼 FPS</strong>
  </p>
  <p>
...
<td width="55%" valign="top" style="padding:15px;">
  ...
  <p align="center">
    <strong>데이터 기반 멀티플레이 환경에서 다채로운 스킬과 액션을 구현한 RPG</strong>
  </p>
  <p>
    서버 권위 멀티플레이 환경을 기반으로 설계되었으며, 전투, 성장, 자원 등 모든 핵심 시스템을 데이터 테이블 중심으로 구축했습니다. 이 구조는 코드 수정 없이도 신규 콘텐츠 추가와 밸런스 조정이 용이하여 높은 확장성을 가집니다.
  </p>
  <div align="left">
    <p><strong>주요 구현 내용:</strong></p>
    <ul>
      <li><b>통합 상호작용 시스템</b>: 아이템, 건축물, 상자 등 모든 오브젝트와의 상호작용을 단일 인터페이스로 통일하여 서버 권위로 관리합니다.</li>
      <li><b>다채로운 플레이어 액션</b>: 이동, 회피, 글라이딩 등 기본 동작과 무기별 공격, 팰 포획 등 다양한 액션을 구현했습니다.</li>
...
<td width="55%" valign="top" style="padding:15px;">
  ...
  <p align="center">
    <strong>독자적인 '강인도' 시스템으로 소울라이크 전투의 정수를 구현한 액션 게임</strong>
  </p>
  <p>
  ...
  <div align="left">
    <p><strong>주요 구현 내용:</strong></p>
    <ul>
      <li><b>강인도 기반 경직 시스템</b>: 공격 강인도 vs 방어 강인도를 비교하고 경직 우선순위를 따져 상태를 갱신합니다. 특정 동작 중에는 강인도 보너스(슈퍼아머)가 적용되어 약한 공격에 경직되지 않으며, 이를 통해 일관된 전투 경험을 제공합니다.</li>
